...
-- Módulo I
--
-- Creado de pedidos aleatorios (Compras y despachos)
------------------------------------------------------------------------------------------------------

--Funciones:

--Funcion que crea los productos de un pedido, aleatoriamente selecciona de uno a tres productos
--les otorga precios de entre 0.5 y 15$
--inserta los productos en la BD y retorna el TOTAL del pedido
...
--Funcion que busca y retorna la sucursal mas cercana de la aliada dependiendo de la direccion del usuario que solicita el pedido
...
--Funcion que busca y retorna la oficina mas cercana (en donde estan las unidades de delivery de la app) a la sucursal dada
...
--Funcion que busca y retorna el id de la unidad desocupada para la entrega del pedido, dependiendo de la app, oficina y fecha
